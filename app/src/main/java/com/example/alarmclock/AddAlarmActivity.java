...
import com.example.alarmclock.Reminder.AlarmSchedualer;
...
public class AddAlarmActivity extends AppCompatActivity implements TimePickerDialog.OnTimeSetListener,
        ...
        switch (item.getItemId()) {
            ...
            case android.R.id.home:
                ...
                if (!mVehicleHasChanged) {
                    NavUtils.navigateUpFromSameTask(AddAlarmActivity.this);
                    return true;
                }
    ...
    private void deleteReminder() {
        ...
        if (mCurrentReminderUri != null) {
            ...
            new AlarmSchedualer().cancelAlarm(getApplicationContext(), mCurrentReminderUri);
...
*/
        ...
        if (mActive.equals("true")) {
            if (mRepeat.equals("true")) {
                new AlarmSchedualer().setRepeatAlarm(getApplicationContext(), selectedTimestamp, mCurrentReminderUri, mRepeatTime);
            } else if (mRepeat.equals("false")) {
                new AlarmSchedualer().setAlarm(getApplicationContext(), selectedTimestamp, mCurrentReminderUri);
            }
